                            ...
                            <tbody>
                                <?php foreach ($payments as $pay): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $ps_map = ['pending' => 'badge-warning', 'verified' => 'badge-success', 'failed' => 'badge-danger'];
                                            $ps_cls = $ps_map[$pay['STATUS']] ?? 'badge-gray';
                                            ?>
                                            <span class="status-badge <?php echo $ps_cls; ?>"><?php echo e(ucfirst($pay['STATUS'])); ?></span>
                                        </td>
